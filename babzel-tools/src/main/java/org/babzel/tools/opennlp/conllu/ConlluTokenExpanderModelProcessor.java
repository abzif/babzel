...
import org.babzel.tools.opennlp.conllu.convert.ConlluTokenExpansionSamplesConverter;
...
@Component
public class ConlluTokenExpanderModelProcessor extends ConlluModelProcessor<LemmatizerModel, LemmaSample> {
    public ConlluTokenExpanderModelProcessor(
            @NonNull FileUpToDateChecker checker,
            @NonNull ConlluSentencesFactory sentencesFactory,
            @NonNull ConlluTokenExpansionSamplesConverter converter,

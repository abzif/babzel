...
public class SimpleResourceDirectorySupplierTest {
    @Mock
    private RootDirectorySupplier rootDirectorySupplier;
    @InjectMocks
    private SimpleResourceDirectorySupplier supplier;
    ...
    public void getResourceDirName() {
        ...
        assertThat(resPath).isEqualTo(rootPath.resolve("lx-simple"));
    }
}
